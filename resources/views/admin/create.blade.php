...
@endsection
@section('content')
    <form id="createForm" class="row g-3 needs-validation" action="{{ route('create_library') }}" method="post" novalidate>
        @csrf
        @if ($errors->any())
        ...
        <div class="mb-4">
            ...
            <input name="library" type="text" class="form-control" id="library"
                placeholder="The British Library, The Getty Museum..." value="{{ old('library') ? old('library') : '' }}"
                required>
            <div class="invalid-feedback">
                Please fill in this field.
            </div>
            <div id="libraryNote" class="form-text">Required - The name of the institution hosting the digitized
                items</div>
        </div>
        ...
        <div class="mb-4">
            ...
            <div id="quantityNote" class="form-text">Required - An indication of how many digitized items are
                available at this institution</div>
        </div>
        <div class="mb-4">
            ...
            <div id="websiteNote" class="form-text">Required - The URL where the digitized items can be accessed
            </div>
        ...
        <div class="mb-4">
            ...
            <input name="library_name_slug" type="text" class="form-control" id="library_name_slug"
                placeholder="https://..." value="{{ old('library_name_slug') ? old('library_name_slug') : '' }}" required>
            <div id="slugNote" class="form-text">Required - The part of a URL or link that comes after our domain.
        ...
        <div class="mb-4">
            ...
            <div id="isPartOfNote" class="form-text">Indicates is the repository is part of a project made of
                multiple repositories</div>
        </div>
        ...
        <div class="col-12">
            ...
            <button class="btn btn-success" type="submit">Add library <i class="fas fa-plus"></i></button>
            <a class="btn btn-danger pull-right" href="{{ route('admin') }}">
