                    ...
                    <form id="createForm" class="needs-validation"
                        ...
                        <div class="mb-4">
                            <div class="form-check">
                                ...
                                <input name="is_part_of" class="form-check-input" type="checkbox" id="is_part_of"
                                       data-dmmapp="is-part-of" value="1"
                        ...
                        <div id="is_part_of_display">
                            <div class="mb-4">
                                ...
                                <input name="is_part_of_project_name" type="text" class="form-control"
                                       id="is_part_of_project_name" data-dmmapp="is-part-of-project-name"
                        ...
                        <div class="mb-4">
                            <div class="form-check">
                                ...
                                <input name="is_free_cultural_works_license" class="form-check-input" type="checkbox"
                                       id="is_free_cultural_works_license" data-dmmapp="free-cultural-license" value="1"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="notes" class="form-control" id="notes" data-dmmapp="notes" rows="3"
                                      placeholder="Notes about this library...">{{ $library->notes }}</textarea>
                        </div>
                        <hr>
                        ...
                        <div id="has_post_display">
                            <div class="mb-4">
                                ...
                                <input name="post_url" type="text" class="form-control" id="post_url"
                                       data-dmmapp="post-url" placeholder="https://"
                        ...
                        <hr>
                        <h3 class="text-danger">Disable linking</h3>
                        <div class="mb-4">
                            <div class="form-check text-danger">
                                <input type="hidden" name="is_disabled" value="0">
                                <input name="is_disabled" class="form-check-input" type="checkbox" id="is_disabled"
                                       data-dmmapp="is_disabled"
                                       value="1" {{ $library->is_disabled == 1 ? ' checked' : '' }}>
                                <label class="form-check-label" for="is_disabled">Repository is no longer
                                    accessible</label>
                            </div>
                            <div id="is_disabledNote" class="form-text">Switch on if the link to this repository no
                                longer
                                works
                            </div>
                        </div>
                        <hr>
                        <div class="mb-4">
                            <label for="last_edited" class="form-label">Last edited</label>
                            <input name="last_edited" type="text" class="form-control" id="last_edited"
                                   data-dmmapp="last_edited"
                                   placeholder="1970-01-01"
                                   value="{{ \Carbon\Carbon::today()->format('Y-m-d')}}">
                            <div class="invalid-feedback">
                                Please check this field
                            </div>
                            <div id="lastEditedNote" class="form-text">The date this repository was last edited
                            </div>
                        </div>
                        <hr>
                        <div class="col-12">
                            ...
                            <button class="btn btn-success float-end" type="submit" data-dmmapp="submit"><i
                                    class="bi bi-pencil-square"></i> Update library
                            </button>
                        </div>
                    </form>
                </div>
