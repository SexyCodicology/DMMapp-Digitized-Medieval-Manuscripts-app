// This fileis used to render the datatable in the map page. It is loaded in resources/views/public/map.blade.php
function initMap() {
    ...
    $(function () {
        let table = $('#dmmtable').DataTable({
            dom: 'Blfrtip', data: libraries, order: [], responsive: true, searchPanes: {
