...
$(function () {
    let table = $('.dmmapp-datatable').DataTable({
        dom: 'PBlfrtip', data: libraries, order: [], buttons: [{
            extend: 'csvHtml5',
            ...
            target: 1, responsivePriority: 2, searchPanes: {
                show: false
            ...
            targets: [4, 6, 7, 8, 9], visible: false, searchable: true
        }, {
            targets: [4, 8, 9, 10, 11, 12], searchPanes: {
                show: false
            }
        }, {
            targets: [8, 9], visible: false, searchable: false
        }, {
            target: 10, orderable: false, render: function (data, type, row) {
            ...
            target: 11, orderable: false, render: function (data, type, row) {
