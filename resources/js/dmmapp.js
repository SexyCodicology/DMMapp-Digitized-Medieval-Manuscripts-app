            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data) {
                        ...
                        if (data === 1) {
                            return "<p style='display:none'>yes</p><i class='bi-2x fa-check-circle text-success'></i>";

                        }
                        else {
                            return "<p style='display:none'>no</p><i class='bi-2x fa-times-circle text-danger'></i>";
                        }
                    }
                },
                {
